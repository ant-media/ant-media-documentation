...
[play page creation using JS SDK](https://antmedia.io/docs/guides/advanced-usage/webrtc-play-page-creation-tutorial/)
[publish page creation using JS SDK](https://antmedia.io/docs/guides/advanced-usage/webrtc-publish-page-creation-tutorial/)
