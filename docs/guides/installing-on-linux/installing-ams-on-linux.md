...
Ant Media can be installed on Linux, specifically Ubuntu (18.04, 20.04, 22.04, and 24.04), CentOS (8 and 9), and Alma Linux (8 and 9). It is compatible with both the x86-64 and Arm64 architectures.
