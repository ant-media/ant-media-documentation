...
- Then click the `Start Publishing` button. After pressing the button, the text `Publishing` should blink and you'll see live stats (bitrate, round-trip time, resolution, FPS) on the page.
