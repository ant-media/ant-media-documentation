...
*This is what a successful publish looks like: the `Publishing` status turns green, and you get real-time stats (bitrate, round-trip time, resolution, FPS) right on the page.*

</div>

From here, see [WebRTC Playback](/guides/playing-live-stream/webrtc-playback/) to play the stream back, or [WHIP](/guides/publish-live-stream/webrtc/whip/) if you need standards-based signaling instead.
