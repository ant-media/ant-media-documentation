...
To set broadcast level ABR, send a ```PUT``` request and update broadcast objects ```encoderSettings``` field with desired ABR settings.
...
All ABR resolution options (240p,360p,480p,640p,720p,1080p,2160p,2880p):
