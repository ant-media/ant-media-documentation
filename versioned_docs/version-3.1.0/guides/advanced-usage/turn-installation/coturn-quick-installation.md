...
For background on when TURN is required, see [TURN Server Installation](/guides/advanced-usage/turn-installation/).
...
For scaling relay traffic across multiple Coturn nodes, see [TURN Load Balancing](/guides/advanced-usage/turn-installation/turn-load-balancing/).

## Related guides

- [TURN Server Installation](/guides/advanced-usage/turn-installation/) — when STUN is enough and when TURN is required.
...
- [TURN Load Balancing](/guides/advanced-usage/turn-installation/turn-load-balancing/) — distribute relay load across multiple servers.
