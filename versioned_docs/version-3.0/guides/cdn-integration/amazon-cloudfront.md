...
4. Configure the origin:
   ...
   - **Origin path**: Enter the name of your Ant Media Server [application](https://antmedia.io/docs/guides/developer-sdk-and-api/extend-the-server/applications/create-new-application/) (e.g., `live`).
