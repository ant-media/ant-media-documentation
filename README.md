...
This repository is dedicated to Ant Media Sever's Documentation. If you are looking for the Ant Media Server's code, kindly go through the [Ant Media Server](https://github.com/ant-media/Ant-Media-Server). 
...
Ant Media’s main product is the real-time streaming engine, called Ant Media Server. Currently, 6000+ Ant Media Server instances run in over 120 countries. Apart from the flagship product, Ant Media Enterprise Edition, startups can also enjoy the open-source Community Edition, downloadable from this repo. 
